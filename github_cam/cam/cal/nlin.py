...
def get_nlin_factor_syn(
    ...
    if fname is not None:
        cam.common.DATA_COEF['nlin'] = cam.util.load_h5(fname)['coef']
    else:
        if 'nlin' not in cam.common.DATA_COEF.keys():
            cam.common.DATA_COEF['nlin'] = cam.util.load_h5('%s/data_nlin_poly_coef_syn.h5' % cam.common.FDIR_DATA)['coef']
