...
def load_hdf5_variable(
        variable_name: str,
        file_path: str or AnyPath = None,
        hdf_object: h5py.Dataset = None)-> np.ndarray:
...
def load_hdf5_variable_from_file(
        variable_name: str,
        file_path: str or AnyPath) -> np.ndarray:
    """A function to read in the dark correction data from an HDF5 file.
    This will change as we store our data in NetCDF files
...
def load_hdf5_variable_from_object(
        variable_name: str,
        hdf5_dataset: h5py.Dataset) -> np.ndarray:
    """A function to read in the dark correction data from an HDF5 file.
    This will change as we store our data in NetCDF files
...
def load_hdf5_single_value(
        variable_name: str,
        file_path: str or AnyPath,
        hdf_object: h5py.Dataset) -> np.ndarray:
    """A function to read in the dark correction data from an HDF5 file.
    This will change as we store our data in NetCDF files
...
def load_hdf5_single_value_from_file(
        variable_name: str,
        file_path: str or AnyPath):
    """A function to read in the dark correction data from an HDF5 file.
    This will change as we store our data in NetCDF files
...
def load_hdf5_single_value_from_object(
        variable_name: str,
